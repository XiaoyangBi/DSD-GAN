...
def parse_opts():
    ...
    parser.add_argument("--dataset_name", type=str, default="ours+brush", help="name of the dataset")
    ...
    parser.add_argument("--output_path",type=str,default="D:\FYP\dataset\Aug_painting_brush",help='Local path of images')
    parser.add_argument("--texture_path",type=str,default="D:/FYP/dataset/train_data_landscape",help='Local path of textures')
