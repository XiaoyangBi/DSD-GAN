#this file is modified by Bi Xiaoyang from https://github.com/sniklaus/pytorch-hed
...
if __name__ == '__main__':
	files_path = []
	input_path = "D:\FYP\dataset\Aug_painting" #输入路径
	os.makedirs("D:\FYP\dataset\processed_pic" , exist_ok=True)
	...
	# names = ['Brush']
	for name in names:
		os.makedirs("D:\FYP\dataset\processed_pic/%s" % name , exist_ok=True)
	output_path = "D:\FYP\dataset\processed_pic" #输出路径
